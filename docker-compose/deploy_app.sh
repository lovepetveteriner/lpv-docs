...
BASE_COMPOSE_FILE=/home/selimssevgi/lpv-docs/docker-compose/docker-compose.yml
PROD_COMPOSE_FILE=/home/selimssevgi/lpv-docs/docker-compose/docker-compose.prod.yml
